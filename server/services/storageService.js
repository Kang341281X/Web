...
const TYPES = { jpeg: '.jpg', png: '.png', bmp: '.bmp', webp: '.webp' }
...
export function validateImage(file) {
  ...
  if (!type || !EXTENSIONS.has(extname(file.originalname || '').toLowerCase())) throw Object.assign(new Error('仅支持有效的 JPG、PNG、BMP、WebP 图片'), { status: 400 })
  return type
}
