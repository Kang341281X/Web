...
<template>
  <el-dialog v-model="dialogVisible" title="预览与裁剪" width="min(780px, calc(100% - 24px))" top="4vh" destroy-on-close @closed="destroyCropper">
...
.crop-canvas-wrap { flex: 1; min-width: 0; max-height: 420px; overflow: hidden; border: 1px solid #e4e7ed; border-radius: 4px; background: #f5f7fa }
.crop-source-img { max-width: 100%; display: block }
.crop-sidebar { width: 180px; flex-shrink: 0; display: flex; flex-direction: column; gap: 12px }
.crop-info { background: #f5f7fa; border-radius: 6px; padding: 12px }
